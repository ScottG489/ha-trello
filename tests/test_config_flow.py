...
async def test_flow_user(hass: HomeAssistant) -> None:
    ...
    with patch(
            "custom_components.trello.config_flow.TrelloAdapter",
            new=MockAdapter,
    ), patch(
        "custom_components.trello.async_setup_entry",
        return_value=True,
    ):
...
async def test_options_flow(hass: HomeAssistant) -> None:
    ...
    with patch(
        "custom_components.trello.config_flow.TrelloAdapter",
        new=MockAdapter,
    ), patch("custom_components.trello.async_setup_entry", return_value=True):
...
async def test_options_flow_remove_board(hass: HomeAssistant) -> None:
    ...
    with patch(
        ...
        "custom_components.trello.sensor.async_setup_entry", return_value=True
    ), patch(
        "custom_components.trello.config_flow.dr"
    ) as device_registry:
...
async def test_flow_user_unauthorized(hass: HomeAssistant) -> None:
    ...
    with patch(
        "custom_components.trello.config_flow.TrelloAdapter.get_member",
